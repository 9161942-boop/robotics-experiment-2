...
The simulation followed six explicit steps: manual teaching and point adjustment came first, followed by automatic playback and acceptance checking.
\begin{enumerate}
...
\end{figure}
\begin{figure}[H]\centering\includegraphics[width=0.82\textwidth]{sim_sequence.jpg}\caption{Key simulation frames: approach, grasp and release/reset.}\label{fig:simprocess}\end{figure}
...
\end{figure}
\begin{figure}[H]\centering\includegraphics[width=0.62\textwidth]{real_sequence.jpg}\caption{Key real-machine frames: approach, grasp and placement.}\label{fig:realprocess}\end{figure}
