...
\vspace*{24mm}
\begin{center}
{\color{Navy}\sffamily\bfseries\fontsize{38}{44}\selectfont Experiment 2}\par
\vspace{3mm}
{\color{Blue}\sffamily\fontsize{20}{25}\selectfont Fixed-point Pick-and-place with a mechArm 270}\par
\vspace{5mm}
{\color{Ink}\sffamily\large Laboratory report  /  ROS 2 Humble  /  Gazebo}\par
\end{center}
\vspace{8mm}
\begin{center}
\fcolorbox{Blue!35}{white}{\includegraphics[width=0.88\textwidth]{figures/sim_sequence.jpg}}\par
\vspace{2mm}
{\color{Ink}\sffamily\footnotesize Simulation action sequence used for fixed-point pick-and-place verification}\par
\end{center}
\vspace{8mm}
\noindent\begin{center}
\colorbox{white}{\parbox{0.88\textwidth}{\vspace{4mm}
\begin{tabular}{>{\bfseries\color{Navy}\sffamily}p{0.20\textwidth}p{0.68\textwidth}}
...
\end{center}
\vfill
\noindent\begin{center}{\color{Blue}\sffamily\small Simulation verification  ·  ROS 2 control  ·  Real-arm demonstration}\end{center}
\end{titlepage}
