...
\begin{minipage}{0.53\textwidth}\centering\includegraphics[width=\textwidth]{ppt_manual_panel.png}\end{minipage}
\caption{Simulation debugging artifacts: the waypoint sequence and manual control panel.}\label{fig:simmanual}
\end{figure}
