...
\end{tikzpicture}
\caption{实机代表性画面与设备准备、抓取、搬运、释放和复位动作链。}\label{fig:realflowzh}
\end{figure}
...
\subsection{实机视频}
图~\ref{fig:realflowzh} 将实机代表性画面与动作链并列呈现。提供的竖屏 MP4 记录实体机械臂接近、夹持、抬升、搬运、释放和复位过程；五周期数值结果仍由仿真 CSV 记录支撑。
