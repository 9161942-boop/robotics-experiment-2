...
\node[anchor=north west,xshift=18mm,yshift=-17mm,color=Navy,font=\sffamily\bfseries\small] at (current page.north west) {机器人集成小组项目};
\node[anchor=north east,xshift=-18mm,yshift=-17mm,color=Blue,font=\sffamily\bfseries\small] at (current page.north east) {第 17 组};
...
\node[anchor=south east,xshift=-18mm,yshift=6mm,color=white,font=\sffamily\small] at (current page.south east) {2026 年 9 月};
\end{tikzpicture}
\vspace*{31mm}
\begin{center}
{\color{Teal}\sffamily\bfseries\small 实验报告系列}\par
\vspace{8mm}
{\color{Navy}\sffamily\bfseries\fontsize{40}{46}\selectfont 实验二}\par
\vspace{4mm}
{\color{Blue}\sffamily\fontsize{20}{25}\selectfont 机械臂定点抓取与放置}\par
\vspace{8mm}
{\color{Teal}\rule{0.12\textwidth}{2pt}\hspace{6pt}\rule{0.48\textwidth}{0.6pt}\hspace{6pt}\rule{0.12\textwidth}{2pt}}\par
\vspace{5mm}
{\color{Ink}\sffamily\large 实验报告}\par
\end{center}
\vspace{18mm}
\noindent\begin{center}
\begin{tabular}{>{\bfseries\color{Navy}\sffamily}p{0.22\textwidth}@{\hspace{4mm}}>{\sffamily}p{0.58\textwidth}}
课程 & 机器人集成小组项目 I\\[2mm]
组员 & 杨牧青；兰松语；张凯睿；赵航\\[2mm]
材料版本 & experiment2\_submission\_final\_20260913\_v2\\[2mm]
仓库 & \url{github.com/9161942-boop/robotics-experiment-2}
\end{tabular}
\end{center}
\vfill
\begin{center}{\color{Blue}\sffamily\small 仿真验证  ·  ROS 2 控制  ·  实机演示}\end{center}
\end{titlepage}
