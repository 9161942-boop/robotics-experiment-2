...
\vspace*{24mm}
\begin{center}
{\color{Navy}\sffamily\bfseries\fontsize{38}{44}\selectfont 实验二}\par
\vspace{3mm}
{\color{Blue}\sffamily\fontsize{20}{25}\selectfont 机械臂定点抓取与放置}\par
\vspace{5mm}
{\color{Ink}\sffamily\large 实验报告  /  ROS 2 Humble  /  Gazebo}\par
\end{center}
\vspace{8mm}
\begin{center}
\fcolorbox{Blue!35}{white}{\includegraphics[width=0.88\textwidth]{figures/sim_sequence.jpg}}\par
\vspace{2mm}
{\color{Ink}\sffamily\footnotesize 用于定点抓取与放置验证的仿真动作序列}\par
\end{center}
\vspace{8mm}
...
\end{center}
\vfill
\noindent\begin{center}{\color{Blue}\sffamily\small 仿真验证  ·  ROS 2 控制  ·  实机演示}\end{center}
\end{titlepage}
